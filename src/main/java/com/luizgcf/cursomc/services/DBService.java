...
import com.luizgcf.cursomc.domain.enums.Perfil;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "60603926010", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.addPerfil(Perfil.CLIENTE);
		cli1.getTelefones().addAll(Arrays.asList("999999", "888888"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "ana@gmail.com", "65550493080", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("9199999", "881888"));
		...
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "281487", cli2, c2);
